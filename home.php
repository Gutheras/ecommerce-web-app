...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover" style="background-image: url(img/b1);" data-aos="fade">
      <div class="container">
        <div class="row align-items-start align-items-md-center justify-content-end">
          <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
            <h1 class="mb-2">G&S TEES. Where Style meets comfort.</h1>
            <div class="intro-text text-center text-md-left">
              <p class="mb-4" style="color: #fff; font-size: 22px;">Discover a range of t-shirts that offer both exceptional style and unmatched comfort. Perfect for any day, our tees are a wardrobe essential. </p>
